                            ...
                            <div class="condition-list">
                                <ul class="nav">
                                    <li class="list">
                                        ...
                                        และมีคอมพิวเตอร์หรืออุปกรณ์ที่สามารถเข้าใช้งานเว็บฝึกอบรมได้
                                    </li>
                                    <li class="list">
                                        เว็บฝึกอบรมจำกัดโควต้าสำหรับผู้ที่ยืนยันสิทธิ์การลงทะเบียนเรียบร้อย เพียง 30
...
<script>
    $(document).ready(function(){
        ...
        jQuery.validator.addMethod('studentcode', function(student_code, element){
            ...
            return this.optional(element) || student_code.length > 9 && student_code.match(/[1-6]{1}[0-9]{2}[0-9]{7}/); //59 124 2000 9
